...
png(file.path(out_dir, paste0(Airport_Code, "_ORD_Aircraft_Adaptation_Ranking.png")), width = 1800, height = 600)
ggplot(
  data = New_Adaptation,
  aes(y = Min_Safe_Landing_Speed_Lead, x = reorder(Aircraft_Type, Min_Safe_Landing_Speed_Lead), fill = Min_Safe_Landing_Speed_Lead)
) +
...
png(file.path(out_dir, "Vref Comparison Full.png"), width = 1750*5, height = 550*5, res = 360)
